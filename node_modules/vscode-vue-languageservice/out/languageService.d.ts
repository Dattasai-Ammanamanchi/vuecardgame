...
export declare function createLanguageService(modules: {
    ...
    doValidation: (uri: string, response: (result: vscode.Diagnostic[]) => void, isCancel?: (() => Promise<boolean>) | undefined) => Promise<void>;
    findDefinition: (uri: string, position: vscode.Position) => vscode.Location[] | vscode.LocationLink[];
    ...
    doComplete: (uri: string, position: vscode.Position, context?: vscode.CompletionContext | undefined, getNameCase?: {
    ...
    doCodeLensResolve: (codeLens: vscode.CodeLens) => vscode.CodeLens;
    ...
    getSelectionRanges: (uri: string, positions: vscode.Position[]) => vscode.SelectionRange[] | undefined;
    getColorPresentations: (uri: string, color: vscode.Color, range: vscode.Range) => vscode.ColorPresentation[] | undefined;
    ...
    findDocumentSymbols: (uri: string) => vscode.SymbolInformation[] | undefined;
    findDocumentLinks: (uri: string) => Promise<vscode.DocumentLink[] | undefined>;
    findDocumentColors: (uri: string) => vscode.ColorInformation[] | undefined;
    dispose: () => void;
    __internal__: {
        rootPath: string;
        ...
        getUnrefSugarEdits: (uri: string, progress?: vscode.WorkDoneProgressServerReporter | undefined) => Promise<vscode.TextEdit[]>;
    };
};
