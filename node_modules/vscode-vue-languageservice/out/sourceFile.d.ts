...
export declare function createSourceFile(_document: TextDocument, context: LanguageServiceContext): {
    uri: string;
    ...
    shouldVerifyTsScript: (templateTsHost: ts.LanguageServiceHost, tsUri: string, mode: 1 | 2 | 3 | 4) => 'all' | 'none' | 'unused';
    refs: {
        ...
        sfcScriptForScriptLs: {
            ...
            sourceMapForSuggestion: import("@vue/reactivity").ComputedRef<import(".").TsSourceMap | undefined>;
