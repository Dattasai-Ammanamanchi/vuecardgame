...
export declare function createSourceFiles(): {
    ...
    getAll: () => {
        uri: string;
        getTemplateTagNames: () => Set<string> | undefined;
        getTemplateAttrNames: () => Set<string> | undefined;
        getTextDocument: () => {
            readonly uri: string;
            readonly languageId: string;
            readonly version: number;
            getText: (range?: import("vscode-languageserver-textdocument").Range | undefined) => string;
        ...
        update: (newDocument: TextDocument) => {
        ...
        updateTemplateScript: (templateTsLs: {
            ...
            doComplete: (uri: string, position: vscode.Position, options?: import("typescript").GetCompletionsAtPositionOptions | undefined) => Promise<vscode.CompletionItem[]>;
            ...
            }, cancellationToken?: import("typescript").CancellationToken | undefined) => vscode.Diagnostic[];
            getFoldingRanges: (uri: string) => vscode.FoldingRange[];
            getDocumentSemanticTokens: (uri: string, range: vscode.Range, cancle?: vscode.CancellationToken | undefined) => [number, number, number, number, number][] | undefined;
            callHierarchy: {
            ...
            __internal__: {
                ...
                raw: import("typescript").LanguageService;
                getTextDocument: (uri: string) => TextDocument | undefined;
                getValidTextDocument: (uri: string) => TextDocument | undefined;
                doCompleteSync: (uri: string, position: vscode.Position, options?: import("typescript").GetCompletionsAtPositionOptions | undefined) => vscode.CompletionItem[];
            };
        }) => boolean;
        ...
        getScriptSetupData: () => {
            labels: (import("./parsers/types").TextRange & {
                binarys: {
                    parent: import("./parsers/types").TextRange;
                    vars: (import("./parsers/types").TextRange & {
                        isShortand: boolean;
                        inRoot: boolean;
                    })[];
                    left: import("./parsers/types").TextRange;
                    right: (import("./parsers/types").TextRange & {
                        isComputedCall: boolean;
                        withoutAs: import("./parsers/types").TextRange;
                        as: import("./parsers/types").TextRange | undefined;
                    }) | undefined;
                }[];
                label: import("./parsers/types").TextRange;
                parent: import("./parsers/types").TextRange;
            })[];
        ...
        shouldVerifyTsScript: (templateTsHost: import("typescript/lib/tsserverlibrary").LanguageServiceHost, tsUri: string, mode: 3 | 1 | 2 | 4) => "all" | "none" | "unused";
        refs: {
            document: import("@vue/reactivity").Ref<{
                readonly uri: string;
                readonly languageId: string;
                readonly version: number;
                getText: (range?: import("vscode-languageserver-textdocument").Range | undefined) => string;
            ...
            sfcErrors: import("@vue/reactivity").Ref<{
                range: {
                    start: {
                        line: number;
                        character: number;
            ...
            sfcScriptForScriptLs: {
                ...
                textDocumentForSuggestion: import("@vue/reactivity").ComputedRef<TextDocument | undefined>;
                sourceMap: import("@vue/reactivity").ComputedRef<TsSourceMap>;
                sourceMapForSuggestion: import("@vue/reactivity").ComputedRef<TsSourceMap | undefined>;
