...
export declare function useSfcTemplate(getUnreactiveDoc: () => TextDocument, template: Ref<IDescriptor['template']>, context: LanguageServiceContext): {
    ...
    pugDocument: import("@vue/reactivity").ComputedRef<{
        ...
        pugCode: string;
        htmlCode: string;
        sourceMap: SourceMaps.SourceMap<undefined>;
        error: {
            code: string;
            msg: string;
            line: number;
